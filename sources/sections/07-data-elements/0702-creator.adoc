...
This clause provides data models that satisfy the guidelines stated in <<ISO690,clause 7.1>>.

===== Contribution information

.Contribution model
====
image::relaton-models/images/contribution.png[]
====
...
image::relaton-models/images/contributor.png[]

image::relaton-models/images/identifier.png[]
...
image::relaton-models/images/contributor_person.png[]

image::relaton-models/images/identifier_person.png[]
...
image::relaton-models/images/contributor_organization.png[]

image::relaton-models/images/identifier_org.png[]
